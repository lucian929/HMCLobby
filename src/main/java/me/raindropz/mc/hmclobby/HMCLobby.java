...
public final class HMCLobby extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        saveDefaultConfig();
        getLogger().info("HMCLobby version: " + getConfig().getString("version") + "by Raindropz is now enabled.");
        getLogger().info("This plugin should not be ran on anything other than a lobby server! It will likely break many game mechanics!");
    }
    @Override
    public void onDisable() {
        saveDefaultConfig();
        getLogger().info("HMCLobby version: " + getConfig().getString("version") + " by Raindropz is now disabled.");
    }
}
